...
@WebServlet("/DecrementaQuantitaCarrello")
public class DecrementaQuantitaCarrello extends HttpServlet {
	private static final long serialVersionUID = 1L;
 
    public DecrementaQuantitaCarrello() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// decremento la quantità nel carrello e restituisco con un oggetto json il totale (serve poi in ajax)
		carrello.Decrementa(dose);  
